...
export default function HomeScreen() {
  ...
  // Example: Fetching category data from an API
  // useEffect(() => {
...
{/* Render Categories inside FlatList */}
      <FlatList
        data={[{ key: "categories" }]} // FlatList expects data array
        renderItem={() => (
          <Categories
...
{/* <FlatList
        data={[{ key: "allFood" }]} // FlatList expects data array
        renderItem={() => (
          <Recipe
            categories={categories}
            foods={allFood}
